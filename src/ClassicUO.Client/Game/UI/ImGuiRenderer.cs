    ...
    public class ImGuiRenderer
    {
        ...
        private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
        {
            ...
            if (drawData.TotalVtxCount > _vertexBufferSize)
            {
                ...
                _vertexBuffer = new VertexBuffer(_graphicsDevice, DrawVertDeclaration.Declaration, _vertexBufferSize, BufferUsage.WriteOnly);
            ...
            if (drawData.TotalIdxCount > _indexBufferSize)
            {
                ...
                _indexBuffer = new IndexBuffer(_graphicsDevice, IndexElementSize.SixteenBits, _indexBufferSize, BufferUsage.WriteOnly);
